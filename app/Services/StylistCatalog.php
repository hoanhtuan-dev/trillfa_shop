...
class StylistCatalog
{
    ...
    public function garmentTypes(): array
    {
        return [
            ...
            ['id' => 'top',          'name' => 'Áo sơ mi nữ / Blouse','emoji' => '👚', 'color' => '#7aa7e0', 'img' => '/garment/top'],
            ['id' => 'pants',        'name' => 'Quần nữ',          'emoji' => '👖', 'color' => '#6a8f6a', 'img' => '/garment/pants'],
            ['id' => 'skirt',        'name' => 'Chân váy',         'emoji' => '🩰', 'color' => '#b57bd0', 'img' => '/garment/skirt'],
            ['id' => 'shorts',       'name' => 'Quần short nữ',    'emoji' => '🩳', 'color' => '#e0a95a', 'img' => '/garment/shorts'],
            ['id' => 'jacket',       'name' => 'Áo khoác nữ',      'emoji' => '🧥', 'color' => '#8a6a4a', 'img' => '/garment/jacket'],
            ['id' => 'aodai',        'name' => 'Áo dài (nữ)',      'emoji' => '💃', 'color' => '#d04a4a', 'img' => '/garment/aodai'],
            ['id' => 'set',          'name' => 'Set đồ nữ',        'emoji' => '🧥', 'color' => '#4a7a90', 'img' => '/garment/set'],
            ['id' => 'tshirt',       'name' => 'Áo thun nữ',       'emoji' => '👕', 'color' => '#5aa0c8', 'img' => '/garment/tshirt'],
            ['id' => 'hoodie',       'name' => 'Áo hoodie nữ',     'emoji' => '🧶', 'color' => '#9a7ad0', 'img' => '/garment/hoodie'],
            ['id' => 'denimjacket',  'name' => 'Áo denim nữ',      'emoji' => '🧥', 'color' => '#5a8a9a', 'img' => '/garment/denimjacket'],
            ['id' => 'blazer',       'name' => 'Áo blazer nữ',     'emoji' => '🕴️', 'color' => '#6a7a8a', 'img' => '/garment/blazer'],
            ['id' => 'weddingdress', 'name' => 'Đầm cưới',         'emoji' => '💍', 'color' => '#e8e0d8', 'img' => '/garment/weddingdress'],
            ['id' => 'bodysuit',     'name' => 'Bodysuit nữ',      'emoji' => '🩱', 'color' => '#c88aa0', 'img' => '/garment/bodysuit'],
            ['id' => 'jogger',       'name' => 'Quần jogger nữ',   'emoji' => '👖', 'color' => '#8aa06a', 'img' => '/garment/jogger'],
            ['id' => 'windbreaker',  'name' => 'Áo gió nữ',        'emoji' => '🧥', 'color' => '#6aa0b0', 'img' => '/garment/windbreaker'],
            ['id' => 'tanktop',      'name' => 'Áo ba lỗ nữ',      'emoji' => '🎽', 'color' => '#e0b06a', 'img' => '/garment/tanktop'],
            ['id' => 'bomber',       'name' => 'Áo bomber nữ',     'emoji' => '🧥', 'color' => '#7a6a5a', 'img' => '/garment/bomber'],
        ];
    }
