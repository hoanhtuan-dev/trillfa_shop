...
class StylistCatalog
{
    ...
    {
        return [
            ['id' => 'dress',        'name' => 'Đầm',              'emoji' => '👗', 'color' => '#e8577d', 'img' => '/assets/garments/garment-dress'],
            ['id' => 'top',          'name' => 'Áo sơ mi nữ / Blouse','emoji' => '👚', 'color' => '#7aa7e0', 'img' => '/assets/garments/garment-top'],
            ['id' => 'pants',        'name' => 'Quần nữ',          'emoji' => '👖', 'color' => '#6a8f6a', 'img' => '/assets/garments/garment-pants'],
            ['id' => 'skirt',        'name' => 'Chân váy',         'emoji' => '🩰', 'color' => '#b57bd0', 'img' => '/assets/garments/garment-skirt'],
            ['id' => 'shorts',       'name' => 'Quần short nữ',    'emoji' => '🩳', 'color' => '#e0a95a', 'img' => '/assets/garments/garment-shorts'],
            ['id' => 'jacket',       'name' => 'Áo khoác nữ',      'emoji' => '🧥', 'color' => '#8a6a4a', 'img' => '/assets/garments/garment-jacket'],
            ['id' => 'aodai',        'name' => 'Áo dài (nữ)',      'emoji' => '💃', 'color' => '#d04a4a', 'img' => '/assets/garments/garment-aodai'],
            ['id' => 'set',          'name' => 'Set đồ nữ',        'emoji' => '🧥', 'color' => '#4a7a90', 'img' => '/assets/garments/garment-set'],
            ['id' => 'tshirt',       'name' => 'Áo thun nữ',       'emoji' => '👕', 'color' => '#5aa0c8', 'img' => '/assets/garments/garment-tshirt'],
            ['id' => 'hoodie',       'name' => 'Áo hoodie nữ',     'emoji' => '🧶', 'color' => '#9a7ad0', 'img' => '/assets/garments/garment-hoodie'],
            ['id' => 'denimjacket',  'name' => 'Áo denim nữ',      'emoji' => '🧥', 'color' => '#5a8a9a', 'img' => '/assets/garments/garment-denimjacket'],
            ['id' => 'blazer',       'name' => 'Áo blazer nữ',     'emoji' => '🕴️', 'color' => '#6a7a8a', 'img' => '/assets/garments/garment-blazer'],
            ['id' => 'weddingdress', 'name' => 'Đầm cưới',         'emoji' => '💍', 'color' => '#e8e0d8', 'img' => '/assets/garments/garment-weddingdress'],
            ['id' => 'bodysuit',     'name' => 'Bodysuit nữ',      'emoji' => '🩱', 'color' => '#c88aa0', 'img' => '/assets/garments/garment-bodysuit'],
            ['id' => 'jogger',       'name' => 'Quần jogger nữ',   'emoji' => '👖', 'color' => '#8aa06a', 'img' => '/assets/garments/garment-jogger'],
            ['id' => 'windbreaker',  'name' => 'Áo gió nữ',        'emoji' => '🧥', 'color' => '#6aa0b0', 'img' => '/assets/garments/garment-windbreaker'],
            ['id' => 'tanktop',      'name' => 'Áo ba lỗ nữ',      'emoji' => '🎽', 'color' => '#e0b06a', 'img' => '/assets/garments/garment-tanktop'],
            ['id' => 'bomber',       'name' => 'Áo bomber nữ',     'emoji' => '🧥', 'color' => '#7a6a5a', 'img' => '/assets/garments/garment-bomber'],
        ];
    }
