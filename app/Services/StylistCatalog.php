...
class StylistCatalog
{
    ...
    {
        return [
            ['id' => 'dress',        'name' => 'Đầm',              'emoji' => '👗', 'color' => '#e8577d', 'img' => '/samples/garment-dress.png?v=2'],
            ['id' => 'top',          'name' => 'Áo sơ mi nữ / Blouse','emoji' => '👚', 'color' => '#7aa7e0', 'img' => '/samples/garment-top.png?v=2'],
            ['id' => 'pants',        'name' => 'Quần nữ',          'emoji' => '👖', 'color' => '#6a8f6a', 'img' => '/samples/garment-pants.png?v=2'],
            ['id' => 'skirt',        'name' => 'Chân váy',         'emoji' => '🩰', 'color' => '#b57bd0', 'img' => '/samples/garment-skirt.png?v=2'],
            ['id' => 'shorts',       'name' => 'Quần short nữ',    'emoji' => '🩳', 'color' => '#e0a95a', 'img' => '/samples/garment-shorts.png?v=2'],
            ['id' => 'jacket',       'name' => 'Áo khoác nữ',      'emoji' => '🧥', 'color' => '#8a6a4a', 'img' => '/samples/garment-jacket.png?v=2'],
            ['id' => 'aodai',        'name' => 'Áo dài (nữ)',      'emoji' => '💃', 'color' => '#d04a4a', 'img' => '/samples/garment-aodai.png?v=2'],
            ['id' => 'set',          'name' => 'Set đồ nữ',        'emoji' => '🧥', 'color' => '#4a7a90', 'img' => '/samples/garment-set.png?v=2'],
            ['id' => 'tshirt',       'name' => 'Áo thun nữ',       'emoji' => '👕', 'color' => '#5aa0c8', 'img' => '/samples/garment-tshirt.png?v=2'],
            ['id' => 'hoodie',       'name' => 'Áo hoodie nữ',     'emoji' => '🧶', 'color' => '#9a7ad0', 'img' => '/samples/garment-hoodie.png?v=2'],
            ['id' => 'denimjacket',  'name' => 'Áo denim nữ',      'emoji' => '🧥', 'color' => '#5a8a9a', 'img' => '/samples/garment-denimjacket.png?v=2'],
            ['id' => 'blazer',       'name' => 'Áo blazer nữ',     'emoji' => '🕴️', 'color' => '#6a7a8a', 'img' => '/samples/garment-blazer.png?v=2'],
            ['id' => 'weddingdress', 'name' => 'Đầm cưới',         'emoji' => '💍', 'color' => '#e8e0d8', 'img' => '/samples/garment-weddingdress.png?v=2'],
            ['id' => 'bodysuit',     'name' => 'Bodysuit nữ',      'emoji' => '🩱', 'color' => '#c88aa0', 'img' => '/samples/garment-bodysuit.png?v=2'],
            ['id' => 'jogger',       'name' => 'Quần jogger nữ',   'emoji' => '👖', 'color' => '#8aa06a', 'img' => '/samples/garment-jogger.png?v=2'],
            ['id' => 'windbreaker',  'name' => 'Áo gió nữ',        'emoji' => '🧥', 'color' => '#6aa0b0', 'img' => '/samples/garment-windbreaker.png?v=2'],
            ['id' => 'tanktop',      'name' => 'Áo ba lỗ nữ',      'emoji' => '🎽', 'color' => '#e0b06a', 'img' => '/samples/garment-tanktop.png?v=2'],
            ['id' => 'bomber',       'name' => 'Áo bomber nữ',     'emoji' => '🧥', 'color' => '#7a6a5a', 'img' => '/samples/garment-bomber.png?v=2'],
        ];
    }
