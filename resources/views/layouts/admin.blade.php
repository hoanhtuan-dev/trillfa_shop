...
<body class="bg-cream-50 text-ink-900 antialiased" x-data="{ sidebar: false }">
    ...
    <aside class="fixed inset-y-0 left-0 z-50 flex w-64 flex-col bg-ink-900 text-cream-50 transition-transform lg:translate-x-0" :class="sidebar ? 'translate-x-0' : '-translate-x-full'">
        ...
        <!-- Trillfa Studio — nổi bật để dễ quảng bá -->
        <div class="px-4 pt-4">
            <a href="{{ route('studio.index') }}" class="group flex items-center gap-3 rounded-2xl bg-gradient-to-r from-brand-600 via-brand-500 to-violet-600 p-3 shadow-lg shadow-brand-600/30 ring-1 ring-white/15 transition hover:from-brand-500 hover:to-violet-500 hover:shadow-brand-500/40">
                <span class="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-white/20 text-white transition group-hover:scale-110">
                ...
                <span class="min-w-0 flex-1">
                    <span class="block truncate text-sm font-bold text-white">Trillfa Studio</span>
                    <span class="block truncate text-[11px] font-medium text-white/75">Thiết kế thời trang AI</span>
                </span>
                <span class="shrink-0 rounded-full bg-white/20 px-2 py-0.5 text-[10px] font-bold text-white">✨ AI</span>
            </a>
        </div>
        ...
        <header class="sticky top-0 z-30 border-b border-cream-200 bg-white/90 backdrop-blur">
            <div class="flex h-16 items-center justify-between gap-4 px-4 sm:px-6">
                ...
                <div class="flex items-center gap-2">
                    <a href="{{ route('studio.index') }}" class="btn-brand btn-sm inline-flex items-center gap-1.5" title="Mở Trillfa Studio — thiết kế thời trang AI">
                        ...
                        <span class="hidden sm:inline">Trillfa Studio</span>
                    </a>
