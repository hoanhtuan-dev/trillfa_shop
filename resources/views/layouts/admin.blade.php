            ...
            @php
                $menu = [
                    'Tổng quan' => [
                        ...
                        ['Báo cáo', route('admin.reports.index'), 'M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z'],
                    ],
                    'Sản phẩm' => [
                    ...
                    'Nội dung' => [
                        ...
                        ['Trang Giới thiệu', route('admin.pages.about'), 'M11.25 4.5H4.5A1.5 1.5 0 003 6v12a1.5 1.5 0 001.5 1.5h15a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5h-7.5m0 0V3a1.5 1.5 0 013-1.5h3a1.5 1.5 0 011.5 1.5v1.5m-6.75 4.5h.008v.008H11.25V9zm-3 4.5h.008v.008H8.25V13.5zm6 0h.008v.008H14.25V13.5zm-3 3h.008v.008H11.25V16.5zm-3 0h.008v.008H8.25V16.5zm6 0h.008v.008H14.25V16.5z'],
