...
<head>
    ...
    @else
        <style>body{margin:0;font-family:system-ui,sans-serif;background:#ecf3ef;color:#0b1210;display:grid;min-height:100vh;place-items:center;text-align:center;padding:24px}h1{font-size:18px;font-weight:700}</style>
    @endif
    @stack('head')
</head>
    ...
    <div id="store-root">
        <div class="grid min-h-screen place-items-center bg-[#eef3f0]">
            <div class="flex flex-col items-center gap-4 text-ink-500">
                ...
                <p class="text-sm font-medium">Đang tải cửa hàng…</p>
            </div>
        </div>
    </div>
