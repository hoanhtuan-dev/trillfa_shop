...
<div class="container-x py-12">
    <div class="mx-auto w-full max-w-2xl">
        <div class="card p-8 sm:p-10">
            ...
            <div class="mt-6 flex items-start gap-3 rounded-2xl border border-brand-200 bg-brand-50 p-5 text-sm text-ink-700">
            ...
            @if($pendingUser)
                <div class="mt-6 rounded-2xl border border-cream-200 bg-white p-6 text-center">
                    ...
                    <p class="mt-3 text-xs text-ink-500">Có thể hoàn thiện sau bất cứ lúc nào từ trang này. Nhân viên vẫn sẽ xác nhận đơn dù bạn chưa đăng ký.</p>
                </div>
            @else
                <div class="mt-6 rounded-2xl border border-cream-200 bg-white p-6 text-center">
                    @auth
