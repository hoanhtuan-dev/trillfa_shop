            ...
            <div class="hidden flex-1 max-w-xl md:block" x-data="searchBox">
                <div class="relative">
                    <input
                        ...
                        class="input !rounded-full !py-2.5 pl-4 pr-4"
                    >
    ...
    <div x-show="mobileOpen" x-collapse class="border-t border-cream-200 lg:hidden">
        <div class="container-x space-y-1 py-4">
            <div x-data="searchBox" class="pb-3">
                <div class="relative">
                    <input x-model="query" @input="onInput" @keydown.enter.prevent="go()" type="search" placeholder="Tìm kiếm sản phẩm..." class="input !rounded-full !py-2.5 pl-4 pr-4">
