...
@section('account_content')
    ...
    <!-- Trillfa Studio entry -->
    <a href="{{ route('studio.index') }}" class="card mb-6 flex flex-wrap items-center justify-between gap-4 !border-brand-200 bg-brand-50 p-6 transition hover:!border-brand-400">
        <div class="flex items-center gap-4">
            <span class="grid h-12 w-12 place-items-center rounded-2xl bg-brand-600 text-white">
                <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.6"><path stroke-linecap="round" stroke-linejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09z"/><path stroke-linecap="round" stroke-linejoin="round" d="M18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456z"/></svg>
            </span>
            <div>
                <p class="font-display text-lg font-semibold text-ink-900">Trillfa Studio — Giám đốc sáng tạo AI</p>
                <p class="text-sm text-ink-600">Biến ý tưởng thành ảnh & video catwalk. Bạn còn <strong class="text-brand-700">{{ auth()->user()->credits_balance }}</strong> tín dụng.</p>
            </div>
        </div>
        <span class="btn-brand btn-sm">Mở Studio →</span>
    </a>
