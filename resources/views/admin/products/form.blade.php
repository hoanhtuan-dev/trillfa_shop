    ...
    <form method="POST" action="{{ $product->exists ? route('admin.products.update', $product) : route('admin.products.store') }}" enctype="multipart/form-data" class="grid gap-6 lg:grid-cols-3">
            ...
            <div class="card p-6">
                ...
                <div class="space-y-3">
                    <template x-for="(v, i) in variants" :key="i">
                        <div class="grid grid-cols-2 gap-3 rounded-2xl border border-cream-200 p-3 sm:grid-cols-5">
        ...
        <div class="space-y-6">
            ...
            <div class="card p-6" x-data="galleryUploader({ existing: {{ Js::from($existingGallery) }} })">
                ...
                <button type="button" @click="$refs.file.click()" class="flex w-full flex-col items-center justify-center rounded-2xl border-2 border-dashed border-cream-300 p-5 text-center transition hover:border-brand-500">
