...
export const useStudioStore = defineStore('studio', {
  ...
  actions: {
    ...
    async compose(images, prompt, variants = 1, mode = 'compose', density = 'sparse') {
      ...
      try {
        const d = await this.api('/studio/compose', { images, prompt, variants: Number(variants) || 1, mode, density });
        const items = Array.isArray(d.items) ? d.items : (d.generation_id ? [d] : []);
