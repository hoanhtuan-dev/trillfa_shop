  ...
  <div v-if="store.upscaleSrc" class="pointer-events-none absolute inset-x-0 bottom-16 z-40 flex justify-center lg:inset-auto lg:left-2 lg:top-1/2 lg:bottom-auto lg:-translate-y-1/2 lg:justify-start">
    <div class="scrollbar-hide pointer-events-auto flex max-w-[calc(100vw-1.5rem)] items-center gap-1 overflow-x-auto rounded-2xl border border-ink-700 bg-ink-900/85 p-1.5 shadow-xl backdrop-blur lg:max-w-none lg:flex-col lg:items-center lg:overflow-visible">
      <button @click="store.finishDraw(); store.reframeOpen = !store.reframeOpen; store.filmOpen = false; store.exitErase(); store.clearInpaintMask()"
        :class="(store.reframeOpen || store.cropMode) ? 'bg-cream-100 text-ink-950 border-cream-300/40 shadow-cream-100/10' : 'text-cream-300 border-transparent hover:bg-ink-700 hover:text-cream-100'"
      ...
      <button @click="store.finishDraw(); store.startCanvasSelect('rect'); store.reframeOpen = false; store.filmOpen = false; store.exitErase()"
        :class="(store.inpaintMaskMode === 'rect' && store.inpaintMaskSource === 'canvas') ? 'bg-cream-100 text-ink-950 border-cream-300/40 shadow-cream-100/10' : 'text-cream-300 border-transparent hover:bg-ink-700 hover:text-cream-100'"
      ...
      <button @click="store.finishDraw(); store.startCanvasSelect('freehand'); store.reframeOpen = false; store.filmOpen = false; store.exitErase()"
        :class="(store.inpaintMaskMode === 'freehand' && store.inpaintMaskSource === 'canvas') ? 'bg-cream-100 text-ink-950 border-cream-300/40 shadow-cream-100/10' : 'text-cream-300 border-transparent hover:bg-ink-700 hover:text-cream-100'"
      ...
      <button @click="store.finishDraw(); store.startCanvasSelect('path'); store.reframeOpen = false; store.filmOpen = false; store.exitErase()"
        :class="(store.inpaintMaskMode === 'path' && store.inpaintMaskSource === 'canvas') ? 'bg-cream-100 text-ink-950 border-cream-300/40 shadow-cream-100/10' : 'text-cream-300 border-transparent hover:bg-ink-700 hover:text-cream-100'"
      ...
      <button @click="store.finishDraw(); store.startCanvasSelect('magic'); store.reframeOpen = false; store.filmOpen = false; store.exitErase()"
        :class="(store.inpaintMaskMode === 'magic' && store.inpaintMaskSource === 'canvas') ? 'bg-cream-100 text-ink-950 border-cream-300/40 shadow-cream-100/10' : 'text-cream-300 border-transparent hover:bg-ink-700 hover:text-cream-100'"
      ...
      <button @click="store.toggleDraw(); store.reframeOpen = false; store.filmOpen = false; store.clearInpaintMask(); store.exitErase()"
        :class="store.drawMode ? 'bg-cream-100 text-ink-950 border-cream-300/40 shadow-cream-100/10' : 'text-cream-300 border-transparent hover:bg-ink-700 hover:text-cream-100'"
      ...
      <button @click="store.finishDraw(); store.toggleErase(); store.reframeOpen = false; store.filmOpen = false; store.clearInpaintMask()"
        :class="store.eraseMode ? 'bg-cream-100 text-ink-950 border-cream-300/40 shadow-cream-100/10' : 'text-cream-300 border-transparent hover:bg-ink-700 hover:text-cream-100'"
      ...
      <button @click="store.finishDraw(); store.filmOpen = !store.filmOpen; store.reframeOpen = false; store.exitErase(); store.clearInpaintMask()"
        :class="(store.filmOpen || store.looking) ? 'bg-cream-100 text-ink-950 border-cream-300/40 shadow-cream-100/10' : 'text-cream-300 border-transparent hover:bg-ink-700 hover:text-cream-100'"
