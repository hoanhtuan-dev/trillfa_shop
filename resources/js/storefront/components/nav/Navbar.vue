    ...
    <header class="sticky top-0 z-40">
        ...
        >
            <div class="sf-container">
                ...
                <nav v-if="nav.length" class="hidden h-12 items-center gap-1 lg:flex">
                    <a
                        v-for="item in nav"
                        :key="item.label"
                        :href="item.url"
                        class="group relative flex h-full items-center rounded-lg px-3 text-sm font-medium text-ink-700 transition-colors hover:text-brand-700"
                    >
                        {{ item.label }}
                        <Icon v-if="item.children && item.children.length" name="chevron-right" :size="14" class="ml-0.5 rotate-90" />
                        <div
                        ...
                        >
                            <a
                                ...
                                :key="child.label"
                                :href="child.url"
                                class="block rounded-xl px-3 py-2 text-sm text-ink-700 hover:bg-cream-100"
                            >{{ child.label }}</a>
                        </div>
                    </a>
                </nav>
